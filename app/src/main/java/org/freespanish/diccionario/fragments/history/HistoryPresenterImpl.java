...
public class HistoryPresenterImpl implements HistoryPresenter {
    ...
    public HistoryPresenterImpl() {
        this.historyInteractor = new HistoryInteractorImpl();
    }
    ...
    @Override
    public ArrayList<Definition> notifyRetrieveHistory(Context context) {
        return this.historyInteractor.retrieveHistory(context);
    }

    @Override
    public void notifyClearHistory(Context context) {
        this.historyInteractor.clearHistory(context);
    }

...
interface SearchPresenter {
    ...
    void onDestroy();
    void prepareDefinition(String word, boolean isAnId);
    void notifyDefinitionToStore(Definition definition, Context context);
    Definition notifyDefinitionToRetrieve(String query, String matchQuery, Context context);
}
